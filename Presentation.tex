...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Not distracting from learning basic concepts
		\item Works with flow of basic concepts
		\item Gives an idea of how good software should be built by giving a language like that
	\end{itemize}
\end{frame}
