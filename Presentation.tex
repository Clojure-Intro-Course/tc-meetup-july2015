...
\begin{document}
\title{Improving Clojure Usablilty for Intro Course Material}
\date{July 1, 2015}

\begin{frame}
\frametitle {Improving Clojure Usablilty for an Intro Course Material}
{\centering
\noindent
...
\begin{frame}
	...
	\begin{itemize}
		\item Clojure is a LISP built on Java
